                    ...
                    <?php else: ?>
                        <div class="equipment-item">
                            ...
                            <div class="equipment-info">
                                ...
                                <div class="equipment-status">
                                    <div class="equipment-status-dot status-operational"></div>
                        ...
                        <div class="equipment-item">
                            ...
                            <div class="equipment-info">
                                <div class="equipment-name">Voltage Tester</div>
                                <div class="equipment-status">
                                    <div class="equipment-status-dot status-maintenance"></div>
                        ...
                        <div class="equipment-item">
                            ...
                            <div class="equipment-info">
                                <div class="equipment-name">Thermal Chamber</div>
                                <div class="equipment-status">
                                    <div class="equipment-status-dot status-operational"></div>
                                    <span>Operational</span>
                                </div>
                        ...
                        <div class="equipment-item">
                            ...
                            <div class="equipment-info">
                                <div class="equipment-name">Pressure Gauge</div>
                                <div class="equipment-status">
                                    <div class="equipment-status-dot status-offline"></div>
                                    <span>Offline</span>
                                </div>
                            </div>
                        </div>
...
async function handleDelete() {
    const testId = document.getElementById('deleteTestId').textContent;
    ...
    deleteBtn.innerHTML = '⏳ Deleting from Database...';
    ...
    try {
        ...
        if (result.success) {
            showNotification('success', 'Database Record Deleted!', result.message);
